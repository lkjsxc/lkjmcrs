...
- Deterministic generated terrain with server-resolved spawn safety.
- Spawn is resolved from the active terrain generator.
...
- Offline-mode name is accepted after protocol number validation.
