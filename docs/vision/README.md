...
- You need the project goal and non-goals.
- You need the scaling philosophy.
- You need docs shape and LLM readability constraints.
- You need the order of major capabilities.
