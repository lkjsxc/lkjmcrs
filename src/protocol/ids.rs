...
pub mod play {
    ...
    pub const SERVERBOUND_CLIENT_COMMAND: i32 = 0x0b;
...
mod tests {
    ...
    fn play_packet_ids_match_protocol_774() {
        ...
        assert_eq!(play::UPDATE_HEALTH, 0x66);
        ...
        assert_eq!(play::SERVERBOUND_CLIENT_COMMAND, 0x0b);
