...
pub fn encode_set_player_inventory(slot_id: i32, slot: Option<Slot<'_>>) -> Vec<u8> {
    let mut out = Vec::new();
...
pub fn encode_slot(out: &mut Vec<u8>, slot: Option<Slot<'_>>) {
...
#[cfg(test)]
mod tests {
    use super::{Slot, encode_set_player_inventory, encode_slot};
